...
class ACellSectionModelExample: ACellSectionModel {
    func cellsHaveSameSection(one: ACellModelExample, another: ACellModelExample) -> Bool {
...
class ACellSectionModelExampleObjC: ACellSectionModel {
    func cellsHaveSameSection(one: ACellModelExampleObjC, another: ACellModelExampleObjC) -> Bool {
        return one.header == another.header
    }
